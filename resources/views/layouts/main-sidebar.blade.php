        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الرئسية</span><span
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoicesUnPaid')) }}">الفواتير الغير
                            مدفوعة</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoicesPartial')) }}">الوافتير المدفوعة
                            جزئيا</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'customersReport')) }}">تقارير العملاء</a>
                    </li>
                </ul>
            </li>
